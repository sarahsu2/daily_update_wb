# mode1 原始数据 mode2 78位置零 mode3 5678位置零
# TODO: 穷举5678位, 前缀换成92, 前缀换成93
    ...
    def CheckCode(self, inputString, mode):
        ...
        if mode == 1:
            ...
            try:
                ...
                # print(merged2[2:5])
                # print(merged2[2:5] == [1,1,0] or merged2[2:5] ==[1,2,0] or merged2[2:5] ==[3,1,0] or merged2[2:5] ==[5,0,0])
...
#     print (Test().CheckCode("330227681055129", 3))
