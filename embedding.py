...
class Embedding:
    ...
    def get(self, k, t=None, default=None):
        try:
            ...
            if t == 'ns':
                return self.embeddings['中国'.encode().decode('utf-8')]
            elif t == 'nr':
                return self.embeddings['江泽民'.encode().decode('utf-8')]
            elif t == 'nz':
                return self.embeddings['傣族'.encode().decode('utf-8')]
            elif t == 'n':
                return self.embeddings['东西'.encode().decode('utf-8')]
            elif t == 'nt':
                return self.embeddings['中共中央'.encode().decode('utf-8')]
            elif t == 'r':
                return self.embeddings['这'.encode().decode('utf-8')]
            elif t == 't':
                return self.embeddings['今天'.encode().decode('utf-8')]
            return default
...
if __name__ == '__main__':
    e = Embedding()
    print (e.get('东西'.encode().decode('utf-8')))
